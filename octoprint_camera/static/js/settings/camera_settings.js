...
$(function () {
    function CameraSettingsViewModel(parameters) {
        ...
        self.state = parameters[3]; // isOperational #TODO needed for usercalibration
        // self.state = {};
        // self.state.isPrinting = ko.observable(false);//#TODO hardcoded for watterott
        // self.state.isPaused =  ko.observable(false);
        // self.state.isOperational =  ko.observable(false);
        // self.state.isLocked = ko.observable(false);

        // self.readyToLaser = parameters[4]; // lid_fully_open & debug tab with mrb state #TODO needed for usercalibration
        self.readyToLaser = {};
        self.readyToLaser.lid_fully_open = ko.observable(true);
    ...
    OCTOPRINT_VIEWMODELS.push([
        ...
        [
            ...
            // "readyToLaserViewModel",//TODO mrbeam
        ],
